...
player.CharacterAppearance = "http://api.xdiscuss.net/user/getCharacter.php?uid=1&mode=pants&key=D869593BF742A42F79915993EF1DB&sid=<?php echo $userid;?>&tick=" .. tick()
